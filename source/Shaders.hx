...
class GlitchyShader extends FlxShader
{
	@:glFragmentSource('
	#pragma header
uniform float iTime;
...
class GlitchyEffect extends Effect
{
...
public function setGlitchy(Offset:Float, SPEED:Float):Void
	{
		shader.SPEED.value = [SPEED];
		shader.AMT.value = [Offset];
	}
